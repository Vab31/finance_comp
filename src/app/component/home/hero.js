  ...
  return (
    ...
    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
      <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
        <h1 class="title-font sm:text-4xl text-3xl mb-4  text-white font-bold">Title Heading
          <br class="hidden lg:inline-block"/>Subheading in single line
        </h1>
        <p class="mb-4 leading-relaxed text-6xl font-serif text-gray-200">Asia Pacific Edition</p>
    <p class="mb-3 leading-relaxed text-3xl font-serif text-gray-200">22 April 2025<br/>
        9:00 AM CET / 1:30 PM IST</p>
